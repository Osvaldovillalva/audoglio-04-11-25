...
namespace Modelo.Migrations
{
    ...
    [Migration("20240604113009_4620240830")]
    partial class _4620240830
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 6, 1, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9477),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 2, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9479),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 3, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9480),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 6, 1, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9511),
                            FechaInicio = new DateTime(2024, 6, 1, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9509),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 25, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9459),
                            FechaPrestamo = new DateTime(2024, 5, 25, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9446),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 30, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9462),
                            FechaPrestamo = new DateTime(2024, 5, 30, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9462),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 6, 1, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9464),
                            FechaPrestamo = new DateTime(2024, 6, 1, 8, 30, 9, 208, DateTimeKind.Local).AddTicks(9464),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
