...
namespace Modelo.Migrations
{
    ...
    [Migration("20240603230737_3620242007")]
    partial class _3620242007
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 31, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3629),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 1, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3631),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 2, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3632),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 31, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3674),
                            FechaInicio = new DateTime(2024, 5, 31, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3672),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 24, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3594),
                            FechaPrestamo = new DateTime(2024, 5, 24, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3573),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 29, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3599),
                            FechaPrestamo = new DateTime(2024, 5, 29, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3598),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 31, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3602),
                            FechaPrestamo = new DateTime(2024, 5, 31, 20, 7, 36, 743, DateTimeKind.Local).AddTicks(3601),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
