...
namespace Modelo.Migrations
{
    ...
    [Migration("20251023223123_AuditoriaInicial")]
    partial class AuditoriaInicial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Auditoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaHora = new DateTime(2025, 10, 23, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(6416),
                            Usuario = "Sistema"
                        });
                });
            ...
            modelBuilder.Entity("Entidades.DetallePago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DetallePagoId = 1,
                            CuotaMensualId = 1,
                            FechaPago = new DateTime(2025, 10, 23, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5966),
                        ...
                        new
                        {
                            DetallePagoId = 2,
                            CuotaMensualId = 2,
                            FechaPago = new DateTime(2025, 10, 23, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5969),
                            MontoCobrado = 2000.00m,
                            SocioId = 2
                        },
                        new
                        {
                            DetallePagoId = 3,
                            CuotaMensualId = 3,
                            FechaPago = new DateTime(2025, 10, 23, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5971),
                            MontoCobrado = 2000.00m,
                            SocioId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2025, 10, 20, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5376),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2025, 10, 21, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5377),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2025, 10, 22, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5378),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2025, 10, 20, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5422),
                            FechaInicio = new DateTime(2025, 10, 20, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5421),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 10, 13, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5352),
                            FechaPrestamo = new DateTime(2025, 10, 13, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5338),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 10, 18, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5355),
                            FechaPrestamo = new DateTime(2025, 10, 18, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5354),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 10, 20, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5357),
                            FechaPrestamo = new DateTime(2025, 10, 20, 19, 31, 23, 145, DateTimeKind.Local).AddTicks(5356),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
