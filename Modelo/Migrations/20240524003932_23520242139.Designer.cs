...
namespace Modelo.Migrations
{
    ...
    [Migration("20240524003932_23520242139")]
    partial class _23520242139
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 20, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3556),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 21, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3558),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 22, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3559),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 20, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3606),
                            FechaInicio = new DateTime(2024, 5, 20, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3605),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 13, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3524),
                            FechaPrestamo = new DateTime(2024, 5, 13, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3507),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 18, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3531),
                            FechaPrestamo = new DateTime(2024, 5, 18, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3531),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 20, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3534),
                            FechaPrestamo = new DateTime(2024, 5, 20, 21, 39, 32, 87, DateTimeKind.Local).AddTicks(3533),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
