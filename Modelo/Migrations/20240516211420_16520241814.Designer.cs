...
namespace Modelo.Migrations
{
    ...
    [Migration("20240516211420_16520241814")]
    partial class _16520241814
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 13, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5257),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 14, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5259),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 15, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5261),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 6, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5212),
                            FechaPrestamo = new DateTime(2024, 5, 6, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5183),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 11, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5219),
                            FechaPrestamo = new DateTime(2024, 5, 11, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5218),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 13, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5221),
                            FechaPrestamo = new DateTime(2024, 5, 13, 18, 14, 20, 174, DateTimeKind.Local).AddTicks(5220),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
