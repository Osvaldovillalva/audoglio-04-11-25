...
namespace Modelo.Migrations
{
    ...
    [Migration("20240521230211_210520242001")]
    partial class _210520242001
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 18, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6460),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 19, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6462),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 20, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6463),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 18, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6515),
                            FechaInicio = new DateTime(2024, 5, 18, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6513),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 11, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6438),
                            FechaPrestamo = new DateTime(2024, 5, 11, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6419),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 16, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6441),
                            FechaPrestamo = new DateTime(2024, 5, 16, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6440),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 18, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6443),
                            FechaPrestamo = new DateTime(2024, 5, 18, 20, 2, 9, 518, DateTimeKind.Local).AddTicks(6442),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
