...
namespace Modelo.Migrations
{
    ...
    [Migration("20240518001016_17520242110")]
    partial class _17520242110
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 14, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7230),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 15, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7231),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 16, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7232),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 7, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7202),
                            FechaPrestamo = new DateTime(2024, 5, 7, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7182),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 12, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7204),
                            FechaPrestamo = new DateTime(2024, 5, 12, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7204),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 14, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7207),
                            FechaPrestamo = new DateTime(2024, 5, 14, 21, 10, 15, 899, DateTimeKind.Local).AddTicks(7206),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
