...
namespace Modelo.Migrations
{
    ...
    [Migration("20250308233740_8320252037")]
    partial class _8320252037
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.DetallePago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DetallePagoId = 1,
                            CuotaMensualId = 1,
                            FechaPago = new DateTime(2025, 3, 8, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1454),
                        ...
                        new
                        {
                            DetallePagoId = 2,
                            CuotaMensualId = 2,
                            FechaPago = new DateTime(2025, 3, 8, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1457),
                            MontoCobrado = 2000.00m,
                            SocioId = 2
                        },
                        new
                        {
                            DetallePagoId = 3,
                            CuotaMensualId = 3,
                            FechaPago = new DateTime(2025, 3, 8, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1460),
                            MontoCobrado = 2000.00m,
                            SocioId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2025, 3, 5, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1332),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2025, 3, 6, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1335),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2025, 3, 7, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1337),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2025, 3, 5, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1387),
                            FechaInicio = new DateTime(2025, 3, 5, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1386),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 2, 26, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1292),
                            FechaPrestamo = new DateTime(2025, 2, 26, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1276),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 3, 3, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1296),
                            FechaPrestamo = new DateTime(2025, 3, 3, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1295),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 3, 5, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1300),
                            FechaPrestamo = new DateTime(2025, 3, 5, 20, 37, 39, 393, DateTimeKind.Local).AddTicks(1299),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
