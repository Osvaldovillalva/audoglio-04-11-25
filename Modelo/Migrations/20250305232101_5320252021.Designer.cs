...
namespace Modelo.Migrations
{
    ...
    [Migration("20250305232101_5320252021")]
    partial class _5320252021
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.DetallePago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DetallePagoId = 1,
                            CuotaMensualId = 1,
                            FechaPago = new DateTime(2025, 3, 5, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8828),
                        ...
                        new
                        {
                            DetallePagoId = 2,
                            CuotaMensualId = 2,
                            FechaPago = new DateTime(2025, 3, 5, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8829),
                            MontoCobrado = 2000.00m,
                            SocioId = 2
                        },
                        new
                        {
                            DetallePagoId = 3,
                            CuotaMensualId = 3,
                            FechaPago = new DateTime(2025, 3, 5, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8831),
                            MontoCobrado = 2000.00m,
                            SocioId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2025, 3, 2, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8747),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2025, 3, 3, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8749),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2025, 3, 4, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8750),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2025, 3, 2, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8782),
                            FechaInicio = new DateTime(2025, 3, 2, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8781),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 2, 23, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8725),
                            FechaPrestamo = new DateTime(2025, 2, 23, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8710),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 2, 28, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8727),
                            FechaPrestamo = new DateTime(2025, 2, 28, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8727),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2025, 3, 2, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8730),
                            FechaPrestamo = new DateTime(2025, 3, 2, 20, 21, 1, 253, DateTimeKind.Local).AddTicks(8729),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
