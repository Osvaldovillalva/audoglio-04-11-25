...
namespace Modelo.Migrations
{
    ...
    [Migration("20240513230108_13520242000")]
    partial class _13520242000
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 10, 20, 1, 8, 131, DateTimeKind.Local).AddTicks(3281),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 11, 20, 1, 8, 131, DateTimeKind.Local).AddTicks(3284),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 12, 20, 1, 8, 131, DateTimeKind.Local).AddTicks(3286),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 3, 20, 1, 8, 131, DateTimeKind.Local).AddTicks(3241),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 8, 20, 1, 8, 131, DateTimeKind.Local).AddTicks(3260),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 10, 20, 1, 8, 131, DateTimeKind.Local).AddTicks(3262),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
