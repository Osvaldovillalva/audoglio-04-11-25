...
namespace Modelo.Migrations
{
    ...
    [Migration("20240513203500_1352024")]
    partial class _1352024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 10, 17, 35, 0, 367, DateTimeKind.Local).AddTicks(9265),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 11, 17, 35, 0, 367, DateTimeKind.Local).AddTicks(9267),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 12, 17, 35, 0, 367, DateTimeKind.Local).AddTicks(9269),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 3, 17, 35, 0, 367, DateTimeKind.Local).AddTicks(9229),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 8, 17, 35, 0, 367, DateTimeKind.Local).AddTicks(9245),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 10, 17, 35, 0, 367, DateTimeKind.Local).AddTicks(9247),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
