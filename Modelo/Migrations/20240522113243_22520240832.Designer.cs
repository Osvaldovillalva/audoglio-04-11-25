...
namespace Modelo.Migrations
{
    ...
    [Migration("20240522113243_22520240832")]
    partial class _22520240832
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 19, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4448),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 20, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4449),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 21, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4451),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 19, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4477),
                            FechaInicio = new DateTime(2024, 5, 19, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4476),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 12, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4428),
                            FechaPrestamo = new DateTime(2024, 5, 12, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4416),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 17, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4432),
                            FechaPrestamo = new DateTime(2024, 5, 17, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4431),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 19, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4434),
                            FechaPrestamo = new DateTime(2024, 5, 19, 8, 32, 43, 451, DateTimeKind.Local).AddTicks(4433),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
