...
namespace Modelo.Migrations
{
    ...
    [Migration("20240603192337_3620241623")]
    partial class _3620241623
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 31, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4039),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 1, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4042),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 2, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4043),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 31, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4079),
                            FechaInicio = new DateTime(2024, 5, 31, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4078),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 24, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4012),
                            FechaPrestamo = new DateTime(2024, 5, 24, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(3996),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 29, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4016),
                            FechaPrestamo = new DateTime(2024, 5, 29, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4015),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 31, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4019),
                            FechaPrestamo = new DateTime(2024, 5, 31, 16, 23, 36, 729, DateTimeKind.Local).AddTicks(4018),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
