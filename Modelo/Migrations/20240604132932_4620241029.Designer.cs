...
namespace Modelo.Migrations
{
    ...
    [Migration("20240604132932_4620241029")]
    partial class _4620241029
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.DetallePago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DetallePagoId = 1,
                            CuotaMensualId = 1,
                            FechaPago = new DateTime(2024, 6, 4, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4693),
                        ...
                        new
                        {
                            DetallePagoId = 2,
                            CuotaMensualId = 2,
                            FechaPago = new DateTime(2024, 6, 4, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4695),
                            MontoCobrado = 2000.00m,
                            SocioId = 2
                        },
                        new
                        {
                            DetallePagoId = 3,
                            CuotaMensualId = 3,
                            FechaPago = new DateTime(2024, 6, 4, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4696),
                            MontoCobrado = 2000.00m,
                            SocioId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 6, 1, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4620),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 2, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4621),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 3, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4623),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 6, 1, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4658),
                            FechaInicio = new DateTime(2024, 6, 1, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4657),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 25, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4600),
                            FechaPrestamo = new DateTime(2024, 5, 25, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4586),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 30, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4603),
                            FechaPrestamo = new DateTime(2024, 5, 30, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4602),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 6, 1, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4605),
                            FechaPrestamo = new DateTime(2024, 6, 1, 10, 29, 32, 85, DateTimeKind.Local).AddTicks(4604),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
