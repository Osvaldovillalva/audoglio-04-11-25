...
namespace Modelo.Migrations
{
    ...
    [Migration("20240603195721_3620241656")]
    partial class _3620241656
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 31, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1667),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 1, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1670),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 2, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1672),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 31, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1768),
                            FechaInicio = new DateTime(2024, 5, 31, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1764),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 24, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1614),
                            FechaPrestamo = new DateTime(2024, 5, 24, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1596),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 29, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1621),
                            FechaPrestamo = new DateTime(2024, 5, 29, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1620),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 31, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1624),
                            FechaPrestamo = new DateTime(2024, 5, 31, 16, 57, 20, 903, DateTimeKind.Local).AddTicks(1623),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
