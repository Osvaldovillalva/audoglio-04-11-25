...
namespace Modelo.Migrations
{
    ...
    [Migration("20240605111900_5620240818")]
    partial class _5620240818
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.DetallePago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DetallePagoId = 1,
                            CuotaMensualId = 1,
                            FechaPago = new DateTime(2024, 6, 5, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8445),
                        ...
                        new
                        {
                            DetallePagoId = 2,
                            CuotaMensualId = 2,
                            FechaPago = new DateTime(2024, 6, 5, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8446),
                            MontoCobrado = 2000.00m,
                            SocioId = 2
                        },
                        new
                        {
                            DetallePagoId = 3,
                            CuotaMensualId = 3,
                            FechaPago = new DateTime(2024, 6, 5, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8448),
                            MontoCobrado = 2000.00m,
                            SocioId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 6, 2, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8335),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 3, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8336),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 4, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8338),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 6, 2, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8409),
                            FechaInicio = new DateTime(2024, 6, 2, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8407),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 26, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8313),
                            FechaPrestamo = new DateTime(2024, 5, 26, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8301),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 31, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8316),
                            FechaPrestamo = new DateTime(2024, 5, 31, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8315),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 6, 2, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8318),
                            FechaPrestamo = new DateTime(2024, 6, 2, 8, 19, 0, 171, DateTimeKind.Local).AddTicks(8317),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
