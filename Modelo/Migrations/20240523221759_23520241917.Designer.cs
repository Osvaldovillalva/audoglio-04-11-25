...
namespace Modelo.Migrations
{
    ...
    [Migration("20240523221759_23520241917")]
    partial class _23520241917
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 20, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1911),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 21, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1916),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 22, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1917),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 20, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1967),
                            FechaInicio = new DateTime(2024, 5, 20, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1966),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 13, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1873),
                            FechaPrestamo = new DateTime(2024, 5, 13, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1854),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 18, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1878),
                            FechaPrestamo = new DateTime(2024, 5, 18, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1877),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 20, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1880),
                            FechaPrestamo = new DateTime(2024, 5, 20, 19, 17, 59, 24, DateTimeKind.Local).AddTicks(1880),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
