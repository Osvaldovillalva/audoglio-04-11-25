...
namespace Modelo.Migrations
{
    ...
    [Migration("20240513000154_initialcreate")]
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 9, 21, 1, 54, 613, DateTimeKind.Local).AddTicks(9363),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 10, 21, 1, 54, 613, DateTimeKind.Local).AddTicks(9365),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 11, 21, 1, 54, 613, DateTimeKind.Local).AddTicks(9367),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 2, 21, 1, 54, 613, DateTimeKind.Local).AddTicks(9321),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 7, 21, 1, 54, 613, DateTimeKind.Local).AddTicks(9340),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 9, 21, 1, 54, 613, DateTimeKind.Local).AddTicks(9342),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
