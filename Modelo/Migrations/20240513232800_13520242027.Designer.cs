...
namespace Modelo.Migrations
{
    ...
    [Migration("20240513232800_13520242027")]
    partial class _13520242027
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 10, 20, 28, 0, 38, DateTimeKind.Local).AddTicks(844),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 11, 20, 28, 0, 38, DateTimeKind.Local).AddTicks(847),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 12, 20, 28, 0, 38, DateTimeKind.Local).AddTicks(849),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 3, 20, 28, 0, 38, DateTimeKind.Local).AddTicks(773),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 8, 20, 28, 0, 38, DateTimeKind.Local).AddTicks(816),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 10, 20, 28, 0, 38, DateTimeKind.Local).AddTicks(818),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
