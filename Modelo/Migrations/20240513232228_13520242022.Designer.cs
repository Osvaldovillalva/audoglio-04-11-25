...
namespace Modelo.Migrations
{
    ...
    [Migration("20240513232228_13520242022")]
    partial class _13520242022
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 10, 20, 22, 27, 947, DateTimeKind.Local).AddTicks(9699),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 11, 20, 22, 27, 947, DateTimeKind.Local).AddTicks(9701),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 12, 20, 22, 27, 947, DateTimeKind.Local).AddTicks(9702),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 3, 20, 22, 27, 947, DateTimeKind.Local).AddTicks(9665),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 8, 20, 22, 27, 947, DateTimeKind.Local).AddTicks(9681),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaPrestamo = new DateTime(2024, 5, 10, 20, 22, 27, 947, DateTimeKind.Local).AddTicks(9683),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
