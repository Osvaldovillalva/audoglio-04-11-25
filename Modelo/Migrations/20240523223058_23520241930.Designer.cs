...
namespace Modelo.Migrations
{
    ...
    [Migration("20240523223058_23520241930")]
    partial class _23520241930
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 20, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1117),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 21, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1118),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 22, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1120),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 20, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1157),
                            FechaInicio = new DateTime(2024, 5, 20, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1156),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 13, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1083),
                            FechaPrestamo = new DateTime(2024, 5, 13, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1064),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 18, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1087),
                            FechaPrestamo = new DateTime(2024, 5, 18, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1086),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 20, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1089),
                            FechaPrestamo = new DateTime(2024, 5, 20, 19, 30, 57, 855, DateTimeKind.Local).AddTicks(1088),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
