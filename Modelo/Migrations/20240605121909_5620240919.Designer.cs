...
namespace Modelo.Migrations
{
    ...
    [Migration("20240605121909_5620240919")]
    partial class _5620240919
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.DetallePago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DetallePagoId = 1,
                            CuotaMensualId = 1,
                            FechaPago = new DateTime(2024, 6, 5, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5654),
                        ...
                        new
                        {
                            DetallePagoId = 2,
                            CuotaMensualId = 2,
                            FechaPago = new DateTime(2024, 6, 5, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5655),
                            MontoCobrado = 2000.00m,
                            SocioId = 2
                        },
                        new
                        {
                            DetallePagoId = 3,
                            CuotaMensualId = 3,
                            FechaPago = new DateTime(2024, 6, 5, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5657),
                            MontoCobrado = 2000.00m,
                            SocioId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 6, 2, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5584),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 6, 3, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5586),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 6, 4, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5587),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 6, 2, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5618),
                            FechaInicio = new DateTime(2024, 6, 2, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5617),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CarritoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 26, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5564),
                            FechaPrestamo = new DateTime(2024, 5, 26, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5545),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            ...
                            CarritoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 31, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5567),
                            FechaPrestamo = new DateTime(2024, 5, 31, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5567),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            ...
                            CarritoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 6, 2, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5570),
                            FechaPrestamo = new DateTime(2024, 6, 2, 9, 19, 9, 76, DateTimeKind.Local).AddTicks(5569),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
