...
namespace Modelo.Migrations
{
    ...
    [Migration("20240521115744_21520240857")]
    partial class _21520240857
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Devolucion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DevolucionId = 1,
                            FechaDevolucion = new DateTime(2024, 5, 18, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8175),
                            PrestamoId = 1
                        },
                        new
                        {
                            DevolucionId = 2,
                            FechaDevolucion = new DateTime(2024, 5, 19, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8177),
                            PrestamoId = 2
                        },
                        new
                        {
                            DevolucionId = 3,
                            FechaDevolucion = new DateTime(2024, 5, 20, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8179),
                            PrestamoId = 3
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Multa", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MultaId = 1,
                            FechaFinalizacion = new DateTime(2024, 5, 18, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8208),
                            FechaInicio = new DateTime(2024, 5, 18, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8207),
                            Pagada = true,
                            SocioId = 1
                        });
                });
            ...
            modelBuilder.Entity("Entidades.Prestamo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PrestamoId = 1,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 11, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8153),
                            FechaPrestamo = new DateTime(2024, 5, 11, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8139),
                            LibroId = 1,
                            SocioId = 1
                        },
                        new
                        {
                            PrestamoId = 2,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 16, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8156),
                            FechaPrestamo = new DateTime(2024, 5, 16, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8156),
                            LibroId = 2,
                            SocioId = 2
                        },
                        new
                        {
                            PrestamoId = 3,
                            EnPrestamo = true,
                            FechaDevolucion = new DateTime(2024, 5, 18, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8158),
                            FechaPrestamo = new DateTime(2024, 5, 18, 8, 57, 44, 252, DateTimeKind.Local).AddTicks(8158),
                            LibroId = 3,
                            SocioId = 3
                        });
                });
