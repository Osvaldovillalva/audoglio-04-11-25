...
namespace Modelo
{
    ...
    new Usuario
    {
        ...
        Dni = "27029674",
        Rol = "Administrador",
        NombreDeUsuario = "27029674",  // El DNI como nombre de usuario
        Clave = "27029674",  // La contraseña es el DNI en texto plano
        PalabraDeSeguridad = "seguridad",  // Palabra de seguridad en texto plano
        Activo = true,
        ClaveModificada = false,  // La contraseña aún no ha sido cambiada
    ...
    new Usuario
    {
        ...
        Dni = "12345678",
        Rol = "Bibliotecario",
        NombreDeUsuario = "12345678",  // El DNI como nombre de usuario
        Clave = "12345678",  // La contraseña es el DNI en texto plano
        PalabraDeSeguridad = "otraPalabraSegura456",  // Palabra de seguridad en texto plano
        Activo = true,  // Usuario activo
        ClaveModificada = false,  // La contraseña aún no ha sido cambiada

        // Permisos deshabilitados para el Bibliotecario
